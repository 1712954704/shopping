...
//        'api/file/add_file', // 需要上传者信息/需要验证
        ...
        'api/user/reset_password', //用户邮件找回密码
    ...
    'default_auth_routes' => [
        ...
        'api/calendar', // 查看日程
        'api/user/get_new_staff_list', // 查看日程
    ],  // 免登录接口
    ...
    // 上传相关
    'img_domain_url'=>'http://192.168.182.250:8023/img/', // 图片域名地址
    'file_domain_url'=>'http://192.168.182.250:8023/file/', // 文件域名地址
    'upload_img_file' => '/home/Item/oa/Code/Resources/file_test/img/', // 用于后台上传图片确定存储位置
    'upload_file' => '/home/Item/oa/Code/Resources/file_test/file/', // 用于后台上传图片确定存储位置
    // log相关
