...
//        'api/file/add_file', // 需要上传者信息/需要验证
    ...
    'default_auth_routes' => [
        ...
        'api/calendar', // 查看日程
        'api/user/get_new_staff_list', // 查看员工分布
],  // 免登录接口
    /** 业务配置 */
    'is_singapore'                       => 0,
    //用户安全
    ...
    // 默认头像地址
    'default_avatar_url' => 'http://www.bio-cloud.com.cn:8022/img/2023-03-20/156C7EDA-15DE-DD54-1818-B845B202D788.png',
    // 上传相关
//    'img_domain_url'=>'http://192.168.182.250:8022/img/', // 图片域名地址
//    'file_domain_url'=>'http://192.168.182.250:8022/file/', // 文件域名地址
    'img_domain_url'=>'http://www.bio-cloud.com.cn:8022/img/', // 图片域名地址
    'file_domain_url'=>'http://www.bio-cloud.com.cn:8022/file/', // 文件域名地址
