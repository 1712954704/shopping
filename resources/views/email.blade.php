...
<div class="box">
    ...
    <div class="contain">
        <div class="main">
            ...
            <p>尊敬的【{{$lead_name}}】领导，您好！</p>
            <br>
            <br>
            <p style="text-indent:2em"> 您的下属员工【{{$name}}】，{{$time}}向您发起了GO-SETTING沟通会议邀请，请您了解，并及时参加！</p>
            <br>
            <br>
            <p> 以上，请多关照。
            </p>
            <br>
            <br>
            <p style="border-top: 1px solid #d1d1d1;
            padding-top: 15px;">{{$name}}</p>
            <p>{{$full_name}}</p>
            <p> Mobile : +86-{{$phone}}</p>
